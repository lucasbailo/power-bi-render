...
export default function InfoContato() {
    ...
    //https://docs.google.com/spreadsheets/d/1i7oAST5BTdceMqY44meAMMwhF6JYTRB6yLECHjEjBHc/edit?usp=sharing

    useEffect(() => {
        const sheetId = "1i7oAST5BTdceMqY44meAMMwhF6JYTRB6yLECHjEjBHc";
        const sheetName = "Info_Contato";
                    ...
                    <thead>
                        <tr>
                            {cabecalhos.map((cab, index) => (
                                <th
                                    key={index}
                                    className="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-white bg-slate-600"
                                >
                                    {cab}
                                </th>
                            ))}
